...
import { getListTGD } from '../Services/GetList';
import Icon from 'react-native-vector-icons/FontAwesome';
import { exportToExcelTGD } from '../Services/ServiceExportExel';
...
const ListGeneralView = ({ navigation }) => {
    ...
    const filteredUsers = users.filter((user) => {
        const userString = `${user.idTGDTab ? `Registro TGD -${user.date}-${user.idTGDTab}` : ''}`;
                    ...
                    <View style={styles.tr} key={item.idDoc}>
                        ...
                        <View style={styles.td}>
                            <Icon
                                ...
                                color="black"
                                onPress={() => {
                                    navigation.navigate('EditarRegistroTGD', { item: item });
                                }}
                            />
                        </View>
                        <View style={styles.td}>
